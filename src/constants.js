...
export const CHANGE_RECENT_TO_LANGUAGE_SELECTOR_STATE = 'CHANGE_RECENT_TO_LANGUAGE_SELECTOR_STATE'
export const CHANGE_RECENT_FROM_LANGUAGE_SELECTOR_STATE = 'CHANGE_RECENT_FROM_LANGUAGE_SELECTOR_STATE'
