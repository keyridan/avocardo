...
export const SET_IMAGE_LOADER_WIDTH = 'SET_IMAGE_LOADER_WIDTH'
export const SET_CELL_POSITIONER = 'SET_CELL_POSITIONER'
export const SET_IMAGE_LOADER_COLUMN_COUNT = 'SET_IMAGE_LOADER_COLUMN_COUNT'
